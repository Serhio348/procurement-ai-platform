...
- [`docs/architecture/STAGE-70.md`](docs/architecture/STAGE-70.md) — «На проверку» открывается туда, где карточку видно
...
- Этап 70 — «На проверку»: open ведёт в Закупки или Мои; решённые не
  возвращаются во входящие как кандидаты
