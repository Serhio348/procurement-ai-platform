...
- [`docs/architecture/STAGE-74.md`](docs/architecture/STAGE-74.md) — «Мои закупки»: список, страницы и профили
...
- Этап 74 — «Мои закупки»: компактный список, пагинация, фильтр по профилю
  плитки
