...
- [`docs/architecture/STAGE-69.md`](docs/architecture/STAGE-69.md) — СМР по электрике: найти и отдать модели в профиле работ
...
- Этап 69 — профиль работ: синоним «строительно-монтажные работы» на
  площадке; СМР без слова «электрооборудование» не veto — модель решает;
  поставка по СМР по-прежнему veto
