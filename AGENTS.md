...
- [`docs/architecture/STAGE-56.md`](docs/architecture/STAGE-56.md) — поиск по кнопке без минуты ожидания
- [`docs/architecture/STAGE-57.md`](docs/architecture/STAGE-57.md) — все фразы профиля на площадку
- [`docs/architecture/STAGE-58.md`](docs/architecture/STAGE-58.md) — скоринг как на 51, фразы все
...
- Этап 56 — «Поиск»: план модели параллельно со списком; карточки
  сомнительных дочитывает только фон
- Этап 57 — на площадку уходят все фразы профиля (кап 4 снят)
- Этап 58 — откат скоринга работ этапа 57: без объекта снова discard,
  монтаж из названия не становится отдельным запросом
