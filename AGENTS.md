...
- [`docs/architecture/STAGE-68.md`](docs/architecture/STAGE-68.md) — универсальный отсев работ по предмету профиля
...
- Этап 68 — профиль работ: СМР/ПНР без объектов профиля — veto; предмет
  задаёт профиль (не отрасль в коде); «Для модели» → description
