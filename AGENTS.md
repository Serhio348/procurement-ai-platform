...
**4.5. Направления поиска — данные, а не код.** Водоподготовка, насосы, дозирование — записи `DomainProfile`. Никогда не создавайте `WaterTreatmentSearchAgent.ts`. Один универсальный `DomainSearchAgent` работает с любым профилем.
