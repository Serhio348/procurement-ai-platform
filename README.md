...
**Статус:** Этап 1 завершён — каркас монорепозитория и фундаментальные пакеты. Агентов, MCP-серверов и адаптеров площадок пока нет.
...
Этап 2 — схема PostgreSQL и миграции под зафиксированные контракты.
