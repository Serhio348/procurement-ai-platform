...
**Статус:** этап 43 — список кабинета читается страницами из PostgreSQL.
У каждого пользователя свой кабинет; карточка площадки и файлы общие по хешу.
...
- [Этап 43 — список кабинета из SQL](docs/architecture/STAGE-43.md)
- [Этап 44 — корзина «Не нужно» / «Убрать»](docs/architecture/STAGE-44.md)
