...
import { OpenAiCompatibleCommercialExtractor } from "../../llm/openai-compatible-commercial-extractor.js";
import { CommercialTermsAgent } from "./agent.js";
import type { CommercialExtractorPort } from "./model-port.js";

export interface CommercialTermsEnvironment {
  LLM_BASE_URL?: string;
  LLM_API_KEY?: string;
  LLM_MODEL?: string;
...
export interface CreateCommercialTermsAgentOptions {
  environment: CommercialTermsEnvironment;
...
export function createCommercialTermsAgent(
  options: CreateCommercialTermsAgentOptions,
): CommercialTermsAgent {
  const model =
    options.model ??
    new OpenAiCompatibleCommercialExtractor({
  ...
  return new CommercialTermsAgent({
