...
5. **NotificationAgent закрыт на этапе 12.** Рекомендация `notification`
   доставляет уже сформированный текст, не вызывая поиск.
...
срез для специалиста. Реализовано, см. [`STAGE-11.md`](STAGE-11.md).
