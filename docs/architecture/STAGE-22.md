...
4. Документы найденных live-процедур качаются на этапе 24 после «Участвовать».
...
См. [`STAGE-24.md`](STAGE-24.md) — документы после «Участвовать». Дальше:
PostgreSQL outbox / decisions либо входящий Telegram-бот.
